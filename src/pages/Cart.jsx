...
const Cart = () => {
    ...
    const { products, navigate, cardCount, totalCardAmount, cartItems, removeFromCard, updateCardItem,axios,user,setCartItems } = useContext(AppContext);
    // console.log(products)

    //state to store product available in card
        ...
        <div className="flex flex-col md:flex-row py-16 max-w-6xl w-full px-6 mx-auto">
            <div className='flex-1 max-w-4xl'>
                <h1 className="text-3xl font-medium mb-6">
                    Shopping Cart <span className="text-sm text-indigo-500">{cardCount()}</span>
                </h1>
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="text-gray-500 mt-4 space-y-2">
                    <p className="flex justify-between">
                        <span>Price</span><span>${totalCardAmount()}</span>
                    </p>
                    <p className="flex justify-between">
                        <span>Shipping Fee</span><span className="text-green-600">Free</span>
                    </p>
                    <p className="flex justify-between">
                        <span>Tax (2%)</span><span>${(totalCardAmount()*2)/100}</span>
                    </p>
                    <p className="flex justify-between text-lg font-medium mt-3">
                        <span>Total Amount:</span><span>${totalCardAmount()+(totalCardAmount()*2)/100}</span>
                    </p>
                </div>
